    ...
    return (
        <div>
            <Button.Group>
                ...
                <Button.Or text='or'/>
                <a href="/pages/JobSeekerRegister.jsx"><Button positive>JobSeeker</Button></a>
            </Button.Group>
            <hr/>
            <br/>
            <br/>
            ...
            <Container>
                ...
                <br/>
                <Button as={NavLink} to="/pages/JobSeekerLogin.jsx" negative>Do you already have an account ?</Button>
            </Container>
        </div>
    )
}